...
uitrue_normal = uitrue = mvrnorm(n, c(0, 0, 0), S %*% biR %*% S)
...
mean(int[2:sim], na.rm = T)
mean(slope[2:sim], na.rm = T)
mean(holdbeta0[2:sim], na.rm = T)
mean(holdbeta1[2:sim], na.rm = T)
mean(holdalpha1[2:sim], na.rm = T)

mean(holdR[1,2,2:sim-1])
mean(holdR[1,3,2:sim-1])
mean(holdR[2,3,2:sim-1])

mean(holdS[1,1,2:sim-1])
mean(holdS[3,3,2:sim-1])
mean(holdS[2,2,2:sim-1])
mean(holdB0[2:sim-1])
